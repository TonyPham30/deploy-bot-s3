(function(KoreSDK){
    ...
    botOptionsWiz.JWTUrl = "https://w7eqbs6bi2.execute-api.ap-northeast-1.amazonaws.com/dev/signin-jwt";
    botOptionsWiz.userIdentity = 'TonyPham';// Provide users email id here
